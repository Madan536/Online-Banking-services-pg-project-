        ...
        <table class="table table-hover table-bordered">
      	  ...
      	  try {
				...
				try {
					...
					PreparedStatement ps=con.prepareStatement("select * from transacation where Account_No="+ request.getParameter("ac"));
					System.out.println("madan ="+request.getParameter("ac"));
