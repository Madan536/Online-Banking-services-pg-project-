...
<body>
        ...
        <li class="nav">
           ...
           %></h4>
            ...
            <ul class="navbar-nav ms-3 mb-2 mb-lg-0">
              <li class="nav-item">
                <a href="Login.jsp?name=out"><button class="btn btn-outline-success" type="submit">Logout</button></a>
  ...
  <div class="container">
    <form action="Password_change?ac=<%= request.getParameter("ac") %>" method="post">
      <div class="mb-3 mt-3">
        <label for="pwd" class="form-label">old Password:</label>
        <input type="text" class="form-control" name="op" placeholder="Password" required>
      </div>
      <div class="mb-3 mt-3">
      ...
      <div class="mb-3 mt-3">
        ...
        <input type="password" class="form-control"  name="cp" placeholder="Confirm Password" required>
      </div>
