...
<body>
    ...
    <div class="container">
        <h1 class="text-center">All Debit Transaction</h1>
    <hr>
        <table class="table table-hover table-bordered">
      	  ...
      	  try {
				...
				try {
					...
					PreparedStatement ps=con.prepareStatement("select * from transacation where tyt=2 and Account_No="+request.getParameter("ac"));
