...
<body>
 ...
 <style>
    ...
    .nav h4{
margin-l:100px !important;
color:black !important;
background-color: rgb(91, 18, 217);
...
<body>
    ...
    <div class="container-fluid">
      ...
      <div class="collapse navbar-collapse " id="navbarNavDropdown">
        ...
        <li class="nav">
           <h4 style="color:white"><%out.println("Admin");
           %></h4>
          </li>
          </ul>
        <ul class="navbar-nav me-2">
...
<% String url ="jdbc:mysql://localhost:3306/Bank";
    ...
    <div class="container">
      <div class="box">
            <p class="text-center">Edit Account</p>
            
           
            <form action="Edit_save?id=<%= rs.getInt(1) %>" method="post">  
        <div class="row">
        ...
        <div class="row">
            <div class="inputbox col-6">
                ...
                <input class="form-control" type="email" placeholder="Email" name="e" value="<%= rs.getString(5) %>" required>
            </div>
            <div class="inputbox col-6">
                <label class="form-label">Phone Number</label>
                <input class="form-control" type="number" maxlength="10" placeholder="Phone Number" name="pn" value="<%= rs.getString(6) %>"required>
            </div>
        </div>
        <div class="row">
            <div class="inputbox col-6">
                <label class="form-label">DOB</label>
                <input class="form-control " type="date" name="dob" value="<%= rs.getString(7) %>">
            </div>
            <div class="inputbox col-6">
            ...
            <div class="inputbox ">
                ...
                <input class="form-control" type="text" placeholder="Address" value="<%= rs.getString(10) %>" name="ad" >
            </div>
            <div class="row">
            <div class="inputbox ">
                <label class="form-label">State</label>
                <input class="form-control" type="text" placeholder="State" value="<%= rs.getString(12) %>" name="s" >
            </div>
            </div>
        <div class="row">
            <div class="inputbox col-6">
                <label class="form-label">City</label>
                <input class="form-control" type="text" value="<%= rs.getString(11) %>" name="c" >
            </div>
            <div class="inputbox col-6">
                <label class="form-label">Pin Code</label>
                <input class="form-control" type="number" value="<%= rs.getString(13) %>" name="pc">
            </div>
        </div>
        <input class="btn btn-success" style="margin-top:20px" type="submit" value="Update">
        </form>
      </div>
    </div>  
     <% 
